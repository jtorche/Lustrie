...
PerlinNoise::PerlinNoise(uint32_t numLayer, uint32_t firstLayerSize, int seed) : _layers(numLayer)
{
...
ImageAlgorithm<float> PerlinNoise::genNoise(uint32_t resolution, int seed, vec2 boundary)
{
